                ...
                {projects.map((project, index) => (
                    ...
                    >
                        ...
                        <div className="relative z-10 max-w-7xl mx-auto w-full">
                            <div className="mb-8">
                                <span className="text-primary font-mono text-xl md:text-2xl mb-4 block">0{index + 1} / 0{projects.length}</span>
                                <h2 className="text-[10vw] leading-none font-bold font-heading uppercase tracking-tighter text-white">
                                    {project.title}
                                </h2>
                            </div>

                            <div className="flex items-center gap-6">
                                <span className="px-6 py-3 border border-white/20 rounded-full text-lg uppercase tracking-wider text-white backdrop-blur-md">
                                    {project.category}
                                </span>
                                <button className="text-white hover:text-primary transition-colors text-lg font-medium border-b border-transparent hover:border-primary">
                                    View Project
                                </button>
                            </div>
                        </div>
